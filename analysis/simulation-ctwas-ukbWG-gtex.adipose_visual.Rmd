...
```{r rerun}
#a <- plot_region(runtag, simutags[1], configtag, chr = 1, startpos = 222230220 , endpos = 224938520 ,  plot_ceqtl = T, rerun_ctwas = T)
...
a <- plot_region(runtag, simutags[1], configtag, chr = 1, startpos =32438685 , endpos = 34799758,  plot_ceqtl = T, rerun_ctwas = T)
