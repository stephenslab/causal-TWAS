...
par(mfrow=c(1,3)); cp_plot(res$pip.null, res$ifcausal, main = "SUSIE.uniform PIP"); cp_plot(res$pip.null, res$ifcausal, main = "SUSIE.uniform PIP"); cp_plot(res$pip.null, res$ifcausal, main = "SUSIE.uniform PIP")
