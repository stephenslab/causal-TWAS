---
title: "Test SUSIE (L=2) for regions near genes (500kb flanking)"
...
name <- "DGCR14"
susieres <- paste0(outputdir, susietag, ".L2-", name, "-susieres.txt")
...
name <- "CRELD2"
susieres <- paste0(outputdir, tag, ".", tag2, ".L2-", name, "-susieres.txt")
plot_all(susieres, mrashres.gene, mrashres.snp, name)
```
