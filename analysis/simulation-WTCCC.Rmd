...
Thus in order to get desired $PVE_{SNP}$ and $PVE_expr$, we will set $\sigma_\theta^2$ and $\sigma_\gamma^2$ based on the following formula:

$$\sigma_\theta^2 = \frac{PVE_{SNP}}{M(1-PVE_{SNP} - PVE_{expr})}$$
$$\sigma_\gamma^2 = \frac{PVE_{expr}}{Jvar(\tilde{X})(1-PVE_{SNP} - PVE_{expr})}$$

## Simulation 1: $J$ = No. of all SNPs, $M$ = No. all genes
