...
### 1.2 $PVE_{SNP}\approx 0.1$, $PVE_{expr}\approx 0.4$
```{r 1.2}
show_res("S1.2")
```
...
### 2.2 $PVE_{SNP} \approx 0.1$, $PVE_{expr} \approx 0.4$
```{r 2.2}
show_res("S2.2")
```
...
### 3.2 $PVE_{SNP} \approx 0.1$, $PVE_{expr} \approx 0.4$
```{r 3.2}
show_res("S3.2")
```
...
### 4.2 $PVE_{SNP} \approx 0.1$, $PVE_{expr} \approx 0.4$
```{r 4.2}
show_res("S4.2")
```
