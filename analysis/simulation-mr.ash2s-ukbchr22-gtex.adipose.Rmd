...
MR.ASH results (start from gene):
```{r sim 5 gene, out.width = "98%", out.height="95%", eval = F}
tag <- "20200616-5"
tag2 <- "expr-res"
...
MR.ASH results (start from gene):
```{r sim 6 gene, out.width = "98%", out.height="95%", eval = F}
tag <- "20200616-6"
tag2 <- "expr-res"
...
```{r sim 7 lasso, out.width = "98%", out.height="95%", eval = F}
tag <- "20200616-7"
tag2 <- "lasso"
...
```{r sim 7 lassosnp, out.width = "98%", out.height="95%", eval = F}
tag <- "20200616-7"
tag2 <- "lassoSNP"
...
### MR.ASH results (use lasso for all):
```{r sim 8 lasso, out.width = "98%", out.height="95%", eval = F}
tag <- "20200616-8"
tag2 <- "lasso"
...
### MR.ASH results (use lasso for just for SNPs):
```{r sim 8 lassosnp, out.width = "98%", out.height="95%", eval = F}
tag <- "20200616-8"
tag2 <- "lassoSNP"
...
```{r sim 20200616-8-7, out.width = "98%", out.height="95%"}
...
print(param)
```
```{r 20200616-8-7, out.width = "98%", out.height="95%"}
