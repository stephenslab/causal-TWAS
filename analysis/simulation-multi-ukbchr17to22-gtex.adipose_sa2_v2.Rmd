...
We use SNP genotype data from chr 17 to chr 22 combined. These genomic regions represents 12.5% of the genome. SNPs are downsampled to 1/10 (randomly), eQTLs (see below for definition of eQTL) were added back. We used lasso to train expression model using GTEx adipose tissue v7. In this simulation, we simulate phenotype with PVE explained by gene as 0.01, by SNP 0.05. pi1 for gene 0.05, pi1 for SNP 0.0025. 
