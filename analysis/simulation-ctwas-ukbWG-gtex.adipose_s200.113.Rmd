---
title: "Simulations to test ctwas summary stats version, 113k samples"
...
print(p2)
# save(p1,p2, file = "data/power_s200.113.Rd")
```
...
```{r param1susie, fig.height=3, fig.width=8, message=F}
configtag <- 1
