...
```{r rBF twas, fig.height=6, fig.width=6}
...
```{r pipdist,fig.height=3, fig.width=9}
par(mfrow = c(1,3))
...
```
```{r pipdist-6,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
```{r pipdist-7,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-9,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-10,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-11,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
```{r param 5, fig.height=11, fig.width=6}
tags <- paste(rep(1:4, each = 5), 1:5, sep = "-")
mr.ashfs <- paste0(mrashdir, "20200721-", tags, "-mr.ash2s.lassoes-es.param.txt")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-5,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
```{r param 13, fig.height=11, fig.width=6}
tags <- paste(rep(1:4, each = 5), 1:5, sep = "-")
mr.ashfs <- paste0(mrashdir, "20200721-", tags, "-mr.ash2s.lassoes-es.param.txt")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-13,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-3,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
...
plot_param(df[16:20,], main = "4-x: gene.pve ~ 0.05, snp.pve ~ 0.05")
```
```{r pipdist-4,fig.height=3, fig.width=12}
par(mfrow = c(1,4))
gpip_dist(susieIfs2[1:5], main = "1-x combined")
gpip_dist(susieIfs2[6:10], main = "2-x combined")
gpip_dist(susieIfs2[11:15], main = "3-x combined")
