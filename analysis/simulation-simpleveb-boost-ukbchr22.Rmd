...
tag <- "mr.ash2_20200503-1"
plot_all(paste0(outputdir, tag, "-mr.ash2.expr-res.expr.txt"), paste0(outputdir, tag, ".exprgwas.txt.gz"), 
         paste0(outputdir, tag, "-mr.ash2.expr-res.snp.txt"), paste0(outputdir, tag, ".snpgwas.txt.gz"))
```
...
tag <- "mr.ash2_20200503-1"
plot_all(paste0(outputdir, tag, "-mr.ash2.snp-res.expr.txt"), paste0(outputdir, tag, ".exprgwas.txt.gz"), 
         paste0(outputdir, tag, "-mr.ash2.snp-res.snp.txt"), paste0(outputdir, tag, ".snpgwas.txt.gz"))
```
...
MR.ASH results (start from gene):
```{r sim 2 gene, eval=T, out.width = "98%", out.height="95%"}
load(paste0(outputdir, "mr.ash2_20200503-2-mr.ash2.expr-res.Rd"))
g.fit <- mr.ash2.fit$fit1
s.fit <-  mr.ash2.fit$fit2
summary_mr.ash2(g.fit, s.fit, phenores)

tag <- "mr.ash2_20200503-2"
plot_all(paste0(outputdir, tag, "-mr.ash2.expr-res.expr.txt"), paste0(outputdir, tag, ".exprgwas.txt.gz"), 
         paste0(outputdir, tag, "-mr.ash2.expr-res.snp.txt"), paste0(outputdir, tag, ".snpgwas.txt.gz"))
```
...
MR.ASH results (start from gene):
```{r sim 3 gene, eval=T, out.width = "98%", out.height="95%"}
load(paste0(outputdir, "mr.ash2_20200503-3-mr.ash2.expr-res.Rd"))
g.fit <- mr.ash2.fit$fit1
s.fit <-  mr.ash2.fit$fit2
summary_mr.ash2(g.fit, s.fit, phenores)

tag <- "mr.ash2_20200503-3"
plot_all(paste0(outputdir, tag, "-mr.ash2.expr-res.expr.txt"), paste0(outputdir, tag, ".exprgwas.txt.gz"), 
         paste0(outputdir, tag, "-mr.ash2.expr-res.snp.txt"), paste0(outputdir, tag, ".snpgwas.txt.gz"))
```
...
MR.ASH results (start from gene):
```{r sim 4 gene, eval=T, out.width = "98%", out.height="95%"}
load(paste0(outputdir, "mr.ash2_20200503-4-mr.ash2.expr-res.Rd"))
g.fit <- mr.ash2.fit$fit1
s.fit <-  mr.ash2.fit$fit2
summary_mr.ash2(g.fit, s.fit, phenores)

tag <- "mr.ash2_20200503-4"
plot_all(paste0(outputdir, tag, "-mr.ash2.expr-res.expr.txt"), paste0(outputdir, tag, ".exprgwas.txt.gz"), 
         paste0(outputdir, tag, "-mr.ash2.expr-res.snp.txt"), paste0(outputdir, tag, ".snpgwas.txt.gz"))
```
