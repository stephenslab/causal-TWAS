---
title: "Simulations (mix normal prior), ctwas_rss, 45k samples"
...
## Data
  ...
  * **GWAS summary statistics** we simulated summary statistics data with different causal gene/SNP proportion and PVE. To simulate this data, we need the following:
      * **genotype data** We used **n = `r as.character(n)` samples**. It is the same as used [here](simulation-ctwas-ukbWG-gtex.adipose_s40.22_041621.html)
