---
title: "Simulations to test ctwas summary stats version, 22k samples"
...
outputdir = "/home/simingz/causalTWAS/simulations/simulation_ctwas_rss_20210113/" # /
comparedir = "/home/simingz/causalTWAS/simulations/simulation_ctwas_rss_20210113_compare/"
...
configtag <- 1
runtag2 = "config1_ctwas_rss_s3_full/ukb-s40.22-adi"

simutags <- paste(1, c(2,4,5), sep = "-")
plot_par(configtag, runtag, simutags)
plot_PIP(configtag, runtag2, simutags)

simutags <- paste(2, c(2,4), sep = "-")
plot_par(configtag, runtag, simutags)
plot_PIP(configtag, runtag2, simutags)
```
...
configtag <- 1
runtag2 = "config1_ctwas_rss_s3_thin/ukb-s40.22-adi"
...
## Results- More simutations + other software
