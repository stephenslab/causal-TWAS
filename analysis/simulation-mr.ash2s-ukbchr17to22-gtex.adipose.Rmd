...
print(param)
plot_all(f$gmrash, f$ggwas, f$smrash, f$sgwas, f$gsusie, f$ssusie, chrom = "17")
```

```{r sim 2 gene, out.width = "98%", out.height="95%"}
plot_all(f$gmrash, f$ggwas, f$smrash, f$sgwas, f$gsusie, f$ssusie, chrom = "18")
```

```{r sim 3 gene, out.width = "98%", out.height="95%"}
plot_all(f$gmrash, f$ggwas, f$smrash, f$sgwas, f$gsusie, f$ssusie, chrom = "19")
```
