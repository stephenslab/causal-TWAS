---
title: "Sparse model: using spike and slab prior"
...
$$ \theta_m | \tau, \pi_\theta\sim (1- \pi_\theta)\delta_0 + \pi_\theta N(0, \sigma_\theta^2/\tau)$$
...
$$
h_{SNP} := \frac{\pi_\theta M\sigma_\theta^2}{\pi_\theta M\sigma_\theta^2 + \pi_\beta Jvar(\tilde{X})\sigma_\beta^2+ 1}$$
$$
h_{expr} := \frac{\pi_\beta Jvar(\tilde{X})\sigma_\beta^2}{\pi_\theta M\sigma_\theta^2 + \pi_\beta Jvar(\tilde{X})\sigma_\beta^2+ 1}$$
