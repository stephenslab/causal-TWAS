...
#' @export
susieI_rss <- function (zdf, ld_pgenfs, ld_exprfs, regionlist, niter = 20,
                        ...
                        coverage = 0.95, ncore = 1, outputdir = getwd(), outname = NULL)
{
  ...
  loginfo("gene_prior %s", prior.gene_init)
  loginfo("SNP_prior %s", prior.SNP_init)
...
assignInNamespace("susieI_rss", susieI_rss ,"ctwas")
