...
# the two alleles.
write.gemma.geno <- function (file, X,  ) {
  geno <- t(geno)
...
run.gemma <- function (phenotype, covariates, pheno, geno, map,
  ...
  write.gemma.pheno(paste0(gemmadir,"/pheno.txt"),phenotype,pheno)  # function in this file gemma.R
  write.gemma.covariates(paste0(gemmadir,"/covariates.txt"),covariates,pheno) # function in this file gemma.R
